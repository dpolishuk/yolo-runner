...
func TestReleasePlaybookExistsForV2_4_0(t *testing.T) {
...
func TestMakefileDefinesReleaseV240Target(t *testing.T) {
	...
	if !strings.Contains(makefile, "release-v2.4.0:") {
		t.Fatalf("Makefile missing release-v2.4.0 target")
	}
	required := []string{
		"git status --short",
		"go test ./...",
